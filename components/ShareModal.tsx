          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">
                Anyone with this link can view your prediction board in real-time.
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-6 space-y-6 overflow-y-auto scrollbar-thin">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={handleCopy}
                className={`flex items-center justify-center gap-2 px-4 rounded-xl font-bold text-xs transition-all duration-300 min-w-[110px] ${
                  copied
                    ? 'bg-brand-lime/10 text-brand-lime border border-brand-lime/20'
                    : 'bg-brand-purple text-white hover:bg-brand-purple/90 shadow-md shadow-brand-purple/20'
                }`}
              >
                {copied ? (
                  <>
